...
<body>
    ...
    <div class="container">
        ...
        <%
            try {
                List<Car> carList = com.car.CarDBUtil.viewAllCars();
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Delete Button -->
                        <form action="cardelete" method="post" onsubmit="return confirm('Are you sure you want to delete this car?');">
