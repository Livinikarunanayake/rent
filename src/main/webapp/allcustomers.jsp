...
<body>
    ...
    <div class="container">
        ...
        <%
            try {
                List<Customer> cus = com.customer.CustomerDBUtil.viewAllCustomers();
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Delete Button -->
                        <form action="customerdelete" method="post" onsubmit="return confirm('Are you sure you want to delete this customer?');">
